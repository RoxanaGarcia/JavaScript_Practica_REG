...
La asignación de desestructuración es una sintaxis especial introducida en ES6, para asignar 
claramente valores tomados directamente de un objeto.
...
Aquí, las variables namey agese crearán y se les asignarán los valores de sus respectivos valores del
 userobjeto. Puedes ver cuánto más limpio es esto.
...
Reemplace las dos asignaciones con una asignación de desestructuración equivalente. Todavía debe asignar
 las variables todayy tomorrowlos valores de todayy tomorrowdesde el HIGH_TEMPERATURESobjeto.

 Debe eliminar la sintaxis de asignación de ES5.
- Debe utilizar la desestructuración para crear la todayvariable.
- Debe utilizar la desestructuración para crear la tomorrowvariable.
- todaydebe ser igual a 77y tomorrowdebe ser igual a 80.
*/
